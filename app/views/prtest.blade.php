			...
			<div class="form-group">
				<div class="row">
					<div class="col-md-6">
						...
						<select  name="modeOfProcurement" id="modeOfProcurement" readonly class="form-control" data-live-search="true">
					...
					<div class="col-md-2">
						{{ Form::label('other', 'Other Type: ', array('class' => 'create-label')) }}
