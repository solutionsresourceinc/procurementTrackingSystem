	...
	<div class="panel-body">
		<table border="1" class="proc-details">
			...
			@foreach($section2 as $section)
				@if($section->taskName != 'PGEPS POSTING')
				<tr>
					<td class="proc-headers" width="20%"><h5>{{{ $section->taskName }}}</h5></td>
					<td class="proc-data" width="20%"></td>
					<td class="proc-data" width="13%"></td>
				...
				<tr>
					<td class="proc-headers" width="20%"></td>
					<td class="proc-data" width="50%" colspan="2"><h5><center>REFERENCE NO.</center></h5></td>
					<td class="proc-data" width="15%"> <center> <h5> DATE :</h5> </center> </td>
					<td class="proc-data" width="15%"> <center> <h5> BY :</h5> </center> </td>
				</tr>
				<tr>
					<td class="proc-headers" width="20%"><h5>{{{ $section->taskName }}}</h5></td>
					<td class="proc-data" colspan="2" width="50%"></td>
					<td class="proc-headers" width="15%"><h5></h5></td>
					<td class="proc-headers" width="15%"><h5></h5></td>
				</tr>
				<tr>
					<td class="proc-headers" width="20%"></td>
